...
if (!baseImage?.length) {
  console.warn(
    'No default image tag specified in enfiy-cli/packages/cli/package.json',
  );
}
...
chmodSync(
  join(cliPackageDir, 'dist', `enfiy-cli-${packageVersion}.tgz`),
  0o755,
);
chmodSync(
  join(corePackageDir, 'dist', `enfiy-core-${packageVersion}.tgz`),
  0o755,
);
