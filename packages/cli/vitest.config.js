...
export default defineConfig({
  test: {
    ...
    exclude: [
      ...
      'src/ui/components/integration.test.tsx',
    ...
    testTimeout:
      typeof process !== 'undefined' && process.env.CI ? 120000 : 60000,
    ...
    teardownTimeout:
      typeof process !== 'undefined' && process.env.CI ? 30000 : 10000,
    // Retry failed tests up to 2 times in CI
    retry: typeof process !== 'undefined' && process.env.CI ? 2 : 0,
