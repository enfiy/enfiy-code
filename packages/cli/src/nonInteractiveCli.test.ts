...
import { Config, EnfiyClient, ToolRegistry } from '@enfiy/core';
...
describe('runNonInteractive', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(EnfiyClient).mockImplementation(() => mockEnfiyClient);
    vi.mocked(ToolRegistry).mockImplementation(() => mockToolRegistry);

    mockConfig = {
      getToolRegistry: vi.fn().mockReturnValue(mockToolRegistry),
      getEnfiyClient: vi.fn().mockReturnValue(mockEnfiyClient),
