...
themes.set('default', () =>
  import('./default.js').then((m) => m.DefaultDark.colors),
);
themes.set('default-light', () =>
  import('./default-light.js').then((m) => m.DefaultLight.colors),
);
themes.set('github-dark', () =>
  import('./github-dark.js').then((m) => m.GitHubDark.colors),
);
themes.set('github-light', () =>
  import('./github-light.js').then((m) => m.GitHubLight.colors),
);
themes.set('atom-one-dark', () =>
  import('./atom-one-dark.js').then((m) => m.AtomOneDark.colors),
);
themes.set('xcode', () => import('./xcode.js').then((m) => m.XCode.colors));
themes.set('googlecode', () =>
  import('./googlecode.js').then((m) => m.GoogleCode.colors),
);
themes.set('ayu', () => import('./ayu.js').then((m) => m.AyuDark.colors));
themes.set('ayu-light', () =>
  import('./ayu-light.js').then((m) => m.AyuLight.colors),
);
themes.set('dracula', () =>
  import('./dracula.js').then((m) => m.Dracula.colors),
);
themes.set('orange', () =>
  import('./orange.js').then((m) => m.DefaultOrange.colors),
);
themes.set('ansi', () => import('./ansi.js').then((m) => m.ANSI.colors));
themes.set('ansi-light', () =>
  import('./ansi-light.js').then((m) => m.ANSILight.colors),
);
themes.set('no-color', () =>
  import('./no-color.js').then((m) => m.NoColorTheme.colors),
);
