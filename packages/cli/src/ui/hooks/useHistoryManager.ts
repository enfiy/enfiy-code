...
export function useHistory(): UseHistoryManagerReturn {
  ...
  return {
    history,
    addItem,
    /** @deprecated Prefer not to update history item directly as we are currently rendering all history items in <Static /> for performance reasons. Only use if ABSOLUTELY NECESSARY */
    updateItem,
    clearItems,
    loadHistory,
  };
