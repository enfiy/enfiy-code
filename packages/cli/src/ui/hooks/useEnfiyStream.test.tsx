...
import { useEnfiyStream, mergePartListUnions } from './useEnfiyStream.js';
...
import { Config, EditorType, AuthType } from '@enfiy/core';
...
// --- Tests for useEnfiyStream Hook ---
describe('useEnfiyStream', () => {
  ...
  beforeEach(() => {
    ...
    // Define the mock for getEnfiyClient
    const mockGetEnfiyClient = vi.fn().mockImplementation(() => {
    ...
    mockConfig = {
      ...
      getEnfiyClient: mockGetEnfiyClient,
  ...
  const renderTestHook = (
    ...
    const client = geminiClient || mockConfig.getEnfiyClient();
  ...
  describe('Client-Initiated Tool Calls', () => {
    it('should execute a client-initiated tool without sending a response to Enfiy', async () => {
