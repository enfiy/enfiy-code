...
import { setEnfiyMdFilename as mockSetEnfiyMdFilename } from '../tools/memoryTool.js';
import {
...
vi.mock('../tools/memoryTool', () => ({
  MemoryTool: vi.fn(),
  setEnfiyMdFilename: vi.fn(),
  getCurrentEnfiyMdFilename: vi.fn(() => 'ENFIY.md'), // Mock the original filename
  DEFAULT_CONTEXT_FILENAME: 'ENFIY.md',
  ENFIY_CONFIG_DIR: '.enfiy',
}));
...
describe('Server Config (config.ts)', () => {
  ...
  it('Config constructor should call setGeminiMdFilename with contextFileName if provided', () => {
    ...
    expect(mockSetEnfiyMdFilename).toHaveBeenCalledWith(contextFileName);
  });

  it('Config constructor should not call setGeminiMdFilename if contextFileName is not provided', () => {
    new Config(baseParams); // baseParams does not have contextFileName
    expect(mockSetEnfiyMdFilename).not.toHaveBeenCalled();
  });
