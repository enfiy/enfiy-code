...
export declare const DEFAULT_ENFIY_FLASH_MODEL = "gemini-2.5-flash";
export declare const DEFAULT_ENFIY_EMBEDDING_MODEL = "gemini-embedding-001";
export declare const DEFAULT_ENFIY_MODEL = "llama3.2:8b";
export declare const DEFAULT_ENFIY_PROVIDER = "ollama";
