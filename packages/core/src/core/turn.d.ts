 ...
 */
import { PartListUnion, GenerateContentResponse, FunctionDeclaration, GenerateContentResponseUsageMetadata } from '@google/genai';
...
export type ServerEnfiyStreamEvent = ServerEnfiyContentEvent | ServerEnfiyToolCallRequestEvent | ServerEnfiyToolCallResponseEvent | ServerEnfiyToolCallConfirmationEvent | ServerEnfiyUserCancelledEvent | ServerEnfiyErrorEvent | ServerEnfiyChatCompressedEvent | ServerEnfiyUsageMetadataEvent | ServerEnfiyThoughtEvent;
export declare class Turn {
    ...
    run(req: PartListUnion, signal: AbortSignal): AsyncGenerator<ServerEnfiyStreamEvent>;
