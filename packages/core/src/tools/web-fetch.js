...
export class WebFetchTool extends BaseTool {
    ...
    async executeFallback(params, signal) {
        ...
        try {
            ...
            const enfiyClient = this.config.getEnfiyClient();
...
${textContent}
---`;
            const result = await enfiyClient.generateContent([{ role: 'user', parts: [{ text: fallbackPrompt }] }], {}, signal);
    ...
    async execute(params, signal) {
        ...
        const enfiyClient = this.config.getEnfiyClient();
        try {
            const response = await enfiyClient.generateContent([{ role: 'user', parts: [{ text: userPrompt }] }], { tools: [{ urlContext: {} }] }, signal);
