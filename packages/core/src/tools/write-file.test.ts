...
const rootDir = path.resolve(os.tmpdir(), 'enfiy-cli-test-root');
...
const mockConfigInternal = {
  ...
  getEnfiyClient: vi.fn(), // Initialize as a plain mock function
  getApiKey: () => 'test-key',
  getModel: () => 'test-model',
  getSandbox: () => false,
  getDebugMode: () => false,
...
describe('WriteFileTool', () => {
  ...
  beforeEach(() => {
    ...
    // Setup EnfiyClient mock
    mockEnfiyClientInstance = new (vi.mocked(EnfiyClient))(
      mockConfig,
