...
export class CodeBlockConverter {
   ...
   */
  static detectLanguage(content, hints) {
   ...
   */
  static extractCodeContent(text) {
    const matches = [];
    // HTML extraction
   ...
   */
  static convertToMarkdown(text, hints) {
   ...
   */
  static wrapInCodeBlock(content, language) {
    if (content.includes('```')) {
...
//# sourceMappingURL=codeBlockConverter.js.map
