...
/**
 * Cached version of getFolderStructure to improve performance for repeated calls
 */
export async function getFolderStructureCached(directory, options) {
  ...
  if (folderStructureCache.size > 50) {
    ...
    for (const [key, entry] of folderStructureCache.entries()) {
