...
vi.mock('../core/client.js', () => ({
  EnfiyClient: vi.fn().mockImplementation(function (
    this: any,
    _config: Config,
  ) {
  ...
  describe('ensureCorrectEdit', () => {
    ...
    beforeEach(() => {
      ...
      mockConfigInstance = {
        ...
        getEnfiyMdFileCount: vi.fn(() => configParams.enfiyMdFileCount),
        setEnfiyMdFileCount: vi.fn((count: number) => {
          configParams.enfiyMdFileCount = count;
        }),
      ...
      mockEnfiyClientInstance = new EnfiyClient(
        mockConfigInstance,
      ) as Mocked<EnfiyClient>;
      resetEditCorrectorCaches_TEST_ONLY();
    });
